...
import com.openu.sadna.booklibrary.data.RepositoryImpl;
...
public class InjectorUtils {
    ...
    private static Repository getRepository(Application application)  {
        return RepositoryImpl.getInstance(RestClient.getInstance().getApiService(), SharedPrefs.getInstance(application));
